...
angular.module('headerController', ['ngMaterial', 'WPAPI']).controller('HeaderCtrl', [
  '$scope', '$rootScope', '$mdSidenav', '$mdMenu', 'UserService', 'MenuService', 'PostService', function($scope, $rootScope, $mdSidenav, $mdMenu, UserService, MenuService, PostService) {
    $scope.$mdMenu = $mdMenu;
    ...
    return $scope.recentPosts = PostService.query();
  }
]);
